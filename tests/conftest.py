...
from nebula.settings import NEBULA_LOGGING_TO_API_ENABLED, temporary_settings
...
def disable_api_logging():
    ...
    """
    with temporary_settings(updates={NEBULA_LOGGING_TO_API_ENABLED: False}):
        yield
...
def _mock_api_app_client(monkeypatch):
    ...
    monkeypatch.setattr(
        "nebula_kubernetes.credentials.KubernetesCredentials.get_client",
        get_client,
    )
